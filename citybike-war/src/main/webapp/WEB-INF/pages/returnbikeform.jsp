				...
				function() {
							...
							$('#userCodeForm').submit(
											function(event) {
												...
												document.getElementById("activeRentSection").hidden = true;
												...
												$.ajax({
															...
															success : function(rent) {
																...
																for (var i = 0; i < rent.length; i++) {
																	...
																	respContent += rent[i].active+"</td><td>";
																	respContent += rent[i].bikeCode+"</td><td>";
																	respContent += rent[i].startDate+"</td><td>";
																	respContent += rent[i].rentDuration+"</td></tr>";
																	}
																
																document.getElementById("activeRentSection").hidden = false;
																
																if(rent.length == 0){
																	document.getElementById("activeRentBtn").hidden = true; 
																	respContent = "<span><b>Brak aktywnych wypożyczeń</b><span>";
																} else{
																	document.getElementById("activeRentBtn").hidden = false; 
																}
																$("#resp").html(respContent);
															}
														});
									...
									function(event) {	
										...
										$.ajax({
													...
													success : function(payment) {
														...
														document.getElementById("activeRentBtn").disable = true; 
													}
												});
